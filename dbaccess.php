<?php
$dsn = 'mysql:host=rds-takahashi.crqmemsomjjy.ap-northeast-1.rds.amazonaws.com;dbname=db_takahashi';
$username = 'svc_user';
$password = 'psvc_user';
...
<?php foreach ($rec as $a):?>
        <?=escape1($a)?><br>
<?php endforeach; ?>
Add comment by Tamiki Takahashi Add comment by Tamiki Takahashi at2.
</body>
</html>
